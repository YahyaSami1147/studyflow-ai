...
function Legend() { return <aside className="rounded-[var(--radius-card)] border border-[var(--line)] bg-white p-5 sm:p-6" aria-label="Calendar legend"><h2 className="font-semibold text-slate-950">Calendar key</h2><div className="mt-4 space-y-3 text-sm text-[var(--muted)]"><p className="flex items-center gap-3"><span className="flex h-7 w-7 items-center justify-center rounded-md bg-blue-50 text-xs font-bold text-blue-800">A</span>Assignment</p><p className="flex items-center gap-3"><span className="flex h-7 w-7 items-center justify-center rounded-md bg-amber-50 text-xs font-bold text-amber-900">T</span>Task</p><p className="flex items-center gap-3"><span className="h-3 w-3 rounded-full bg-blue-600" aria-hidden="true" />Today</p><p className="flex items-center gap-3"><span className="h-3 w-3 rounded-full bg-emerald-500" aria-hidden="true" />Completed</p></div></aside>; }
