...
export function TasksWorkspace() {
  const { data, isHydrated, addTask, updateTask, deleteTask, toggleTask, getOrderedTasks, getCourseById, getAssignmentById } = useStudyFlow();
  ...
  const tasks = getOrderedTasks().filter((task) => filter === "all" ? true : filter === "todo" ? !task.completed : task.completed);
