    ...
    <main className="min-h-screen bg-white">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-4 py-5 sm:px-6 lg:px-10">
        ...
        <div className="flex items-center gap-4 text-sm font-medium">
          ...
          <Link href="/register" className="rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Get started</Link>
        </div>
      </header>
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-20 sm:px-6 lg:px-10 lg:pt-28">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/dashboard" className="inline-flex items-center gap-2 rounded-md bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-blue-700">Open workspace <ArrowRight size={16} aria-hidden="true" /></Link>
