...
function NoCourseState() { return <section className="mt-8 flex flex-col items-center rounded-[var(--radius-card)] border border-dashed border-slate-300 bg-white px-6 py-16 text-center sm:px-10"><div className="flex h-12 w-12 items-center justify-center rounded-full bg-amber-50 text-amber-700"><ClipboardList size={22} aria-hidden="true" /></div><h2 className="mt-5 text-xl font-semibold tracking-tight text-slate-950">Create a course first</h2><p className="mx-auto mt-2 w-full max-w-md text-center text-sm leading-6 text-[var(--muted)]">Assignments belong to courses. Add your first course before creating an assignment.</p><Link href="/courses" className="mt-6 inline-flex h-10 items-center rounded-md bg-blue-600 px-4 text-sm font-semibold text-white hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Go to courses</Link></section>; }
